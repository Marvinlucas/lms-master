                ...
                <div class="col-12">
                    ...
                    <div class="card  mb-4 border-bottom-success">
                        ...
                        <div class="card-header-custom py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-uppercase">{{ __('Departments List') }}</h6>
                                    ...
                                    <tbody>
                                        @forelse ($departments as $department)
                                            <tr>
                                                ...
                                                <td><x-buttons.pill name=""
                                                        count="{{ $department->Course->count() }}" theme="warning" /></td>
                                                <td><x-buttons.pill name="" count="{{ $department->Term->count() }}"
                                                        theme="dark" /></td>
                                                <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown no-arrow">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                                                ...
                                                                @can('department.edit')
                                                                    <x-EditButton itemId="{{ $department->id }}"
                                                                        path="department.edit" />
                                                                @endcan
                                                                @can('department.delete')
                                                                    <x-DeleteButton itemId="{{ $department->id }}"
                                                                        path="department.destroy" />
                                                                @endcan
                                                            </div>
                                                        </div>
                                                    </td>
