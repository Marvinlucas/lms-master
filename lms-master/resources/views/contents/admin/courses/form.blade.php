        ...
        <div class="col-12">
            <div class="card shadow mb-4 border-bottom-success">
                ...
                <div class="card-header-custom py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-uppercase">{{ __('Course Form') }}</h6>
                            ...
                            <div class="col-sm-6 mb-sm-0">
                                <div class="form-group">
                                    ...
                                    <input name="title" type="text" class="form-control form-control-user"
                                        id="title" placeholder="Course Title" value="{{ $course->title ?? '' }}">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <x-forms.DropDown model="Department" name="department_id"
                                        selected="{{ $course->department_id ?? 0 }}" />
                                </div>

                                <div class="form-group">
                                    <textarea name="description" type="text" class="form-control mt-3" id="description" placeholder="Description">{{ $course->description ?? '' }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
