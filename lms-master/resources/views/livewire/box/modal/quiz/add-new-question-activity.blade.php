<div class="dropdown no-arrow">
    <a class="dropdown-item" href="#" id="createSessionButton" data-toggle="modal"
        data-target="#createNewQuestion_{{ $quiz->id }}">
...
<div class="modal fade" id="createNewQuestion_{{ $quiz->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog custom-modals" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close"  aria-label="Close"  onclick="customCloseAddNewQuestionsModal('{{ $quiz->id }}')">
            ...
            <div class="modal-body" style="min-height: 550px;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary close-btn" aria-label="Close"
                        onclick="customCloseAddNewQuestionsModal('{{ $quiz->id }}')">Close</button>
                </div>
        </div>
    </div>
</div>
...
function customCloseAddNewQuestionsModal(quizId) {
    $('#createNewQuestion_' + quizId).modal('hide');
}
</script>
